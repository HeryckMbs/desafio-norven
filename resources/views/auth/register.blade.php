...
@section('content')
    <div class="card-body login-card-body">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="input-group mb-3">
                <input type="password" name="password_confirmation"
                    class="form-control @error('password_confirmation') is-invalid @enderror" placeholder="Confirmar senha"
        ...
        <div class="row">
            <div class="col-12">
                <a href="/login">Já possui cadastro? Entre aqui para fazer login</a>
            </div>
        </div>
    </div>
@endsection
